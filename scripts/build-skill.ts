// Generates skills/fortress-devtools-axi/SKILL.md from shared CLI guidance and
...
if (check) {
  ...
  if (actual !== expected) {
    console.error(
      "skills/fortress-devtools-axi/SKILL.md is out of date. Run `pnpm run build:skill` and commit the result.",
    );
    process.exit(1);
  }
  console.log("skills/fortress-devtools-axi/SKILL.md is up to date.");
} else {
